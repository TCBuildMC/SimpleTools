...
public class JacksonPropertiesParser implements Parser {
    private final JavaPropsMapper mapper;

    @Contract(pure = true)
    public JacksonPropertiesParser(JavaPropsMapper mapper) {
        this.mapper = mapper;
    }

    public JacksonPropertiesParser() {
        this(JavaPropsMapper.builder()
